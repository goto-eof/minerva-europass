...
public class ExperienceFillerUtil {
    ...
    public void fillUpExperience(ResumeDTO resumeDTO, Map<String, Object> result) {
        if (resumeDTO.getExperience() != null) {
            ...
            result.put(ResumeConst.FIELD_EXPERIENCE_LIST, experienceCommonFillerUtil.experiencesToListMap(resumeDTO.getExperience().getExperienceList(), resumeDTO.getLocaleName()));
            ...
            String yearsOfExperiencePerSingleBackEndTechnology = resumeUtil.listToString(resumeUtil.technologiesToYearsOfExperience(resumeDTO.getExperience().getExperienceList(), ExperienceType.BACK_END, templateConfiguration.getMaxSummaryResultsTechYearsExperience(), resumeDTO.getLocaleName()));
            ...
            String yearsOfExperiencePerSingleFrontEndTechnology = resumeUtil.listToString(resumeUtil.technologiesToYearsOfExperience(resumeDTO.getExperience().getExperienceList(), ExperienceType.FRONT_END, templateConfiguration.getMaxSummaryResultsTechYearsExperience(), resumeDTO.getLocaleName()));
